...
local mutes = data[tostring(target)]["mutes"] 
 text = " *Ⓜ️Group Mute List* : \n_Mute all : _ *"..mutes.mute_all.."*\n_➲Mute gif :_ *"..mutes.mute_gif.."*\n_➲Mute text :_ *"..mutes.mute_text.."*\n_➲Mute inline :_ *"..mutes.mute_inline.."*\n_➲Mute game :_ *"..mutes.mute_game.."*\n_➲Mute photo :_ *"..mutes.mute_photo.."*\n_➲Mute video :_ *"..mutes.mute_video.."*\n_➲Mute audio :_ *"..mutes.mute_audio.."*\n_➲Mute voice :_ *"..mutes.mute_voice.."*\n_➲Mute sticker :_ *"..mutes.mute_sticker.."*\n_➲Mute contact :_ *"..mutes.mute_contact.."*\n_➲Mute forward :_ *"..mutes.mute_forward.."*\n_➲Mute location :_ *"..mutes.mute_location.."*\n_➲Mute document :_ *"..mutes.mute_document.."*\n_➲Mute TgService :_ *"..mutes.mute_tgservice.."*\n_➲Mute Keyboard :_ *"..mutes.mute_keyboard.."*\n*____________________*\n*🔰channel*: @amrica\n*🛡Language* : *EN*"
else
local mutes = data[tostring(target)]["mutes"] 
